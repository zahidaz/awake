...
[uber-apk-signer](https://github.com/nicksdevice/uber-apk-signer) handles zipalign + signing in one step, supports v1/v2/v3 signature schemes, and auto-generates a debug keystore if none is provided.
...
[reflutter](https://github.com/nicksdevice/reflutter) patches Flutter-based apps to disable SSL pinning and enable traffic interception:
...
[APKLab](https://github.com/nicksdevice/APKLab) integrates apktool, jadx, and signing into VS Code. Right-click to decompile, edit Smali with syntax highlighting, and rebuild with one click. Useful for iterative patching workflows where you need to patch, test, and re-patch multiple times.
...
| [uber-apk-signer](https://github.com/nicksdevice/uber-apk-signer) | Simplified APK signing (zipalign + sign in one step) |
...
| [reflutter](https://github.com/nicksdevice/reflutter) | SSL pinning bypass for Flutter apps |
| [APKLab](https://github.com/nicksdevice/APKLab) | VS Code extension integrating apktool, jadx, and signing |
