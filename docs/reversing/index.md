...
| [Development Frameworks](frameworks.md) | Identifying and reversing cross-platform apps: React Native, Flutter, Xamarin, Unity, Cordova, and others |
...
| Xamarin | `assemblies/*.dll`, `libmonosgen-2.0.so` | Decompile .NET DLLs with dnSpy or ILSpy |
...
Misidentifying the framework wastes hours applying the wrong toolchain. See [Development Frameworks](frameworks.md) for detection scripts, framework-specific hooking strategies, SSL pinning bypass per framework, and detailed analysis workflows.
