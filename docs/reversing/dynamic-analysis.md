...
**Using [fridump](https://github.com/nicksdevice/fridump)** or similar memory dumping tools.
...
| [frida-dexdump](https://github.com/nicksdevice/frida-dexdump) | Dump DEX files from memory |
| [medusa](https://github.com/Ch0pin/medusa) | Extensible Frida-powered framework for dynamic analysis |
| [house](https://github.com/nicksdevice/house) | Runtime mobile application analysis toolkit |
