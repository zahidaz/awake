...
See also: [Packers](../packers/index.md), [Hooking](../reversing/hooking.md)
...
### Frida: Intercept Dynamic Class Loading

Hook `DexClassLoader` and `InMemoryDexClassLoader` constructors to capture every dynamically loaded payload:
