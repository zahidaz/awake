...
**Android 10 (API 29)**: patched StrandHogg v1 by restricting task affinity behavior for background-launched activities.

**May 2020 Security Patch**: patched StrandHogg 2.0 (CVE-2020-0096).

**Android 12+**: additional restrictions on background activity starts.

Residual risk: on unpatched devices and with certain launch mode configurations, variations of this attack remain possible. The underlying task model hasn't fundamentally changed.
