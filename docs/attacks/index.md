...
| **9. Anti-analysis** | Avoid detection | [`QUERY_ALL_PACKAGES`](../permissions/normal/query-all-packages.md), [Device Admin Abuse](device-admin-abuse.md) | Check for emulators/AV, abuse device admin to resist uninstall, wipe device on detection |
